...
Mã nguồn chính của cơ chế này nằm tại [`app/infrastructure/workspace/crypto.py`](../app/infrastructure/workspace/crypto.py).
...
Đoạn sinh khóa nằm trong hàm `_derive_key()` tại [`crypto.py`](../app/infrastructure/workspace/crypto.py#L280).
...
Logic mã hóa nằm trong `encrypt_zip_payload()` tại [`crypto.py`](../app/infrastructure/workspace/crypto.py#L72).
...
Ứng dụng nhận diện tệp mã hóa bằng magic `NTPAES1\0`, được khai báo tại [`crypto.py`](../app/infrastructure/workspace/crypto.py#L34).
...
Giao diện được định nghĩa trong [`app/UI/qml/welcome/CreateProjectDialog.qml`](../app/UI/qml/welcome/CreateProjectDialog.qml#L92).
...
- [`app/core/welcome.py`](../app/core/welcome.py#L340);
- [`app/infrastructure/workspace/service.py`](../app/infrastructure/workspace/service.py#L61);
- [`app/infrastructure/workspace/package.py`](../app/infrastructure/workspace/package.py#L530).
...
Hộp thoại nhập mật khẩu nằm tại [`app/UI/qml/welcome/WorkspacePasswordDialog.qml`](../app/UI/qml/welcome/WorkspacePasswordDialog.qml).

Logic giải mã nằm trong `decrypt_zip_payload()` tại [`crypto.py`](../app/infrastructure/workspace/crypto.py#L130), còn quy trình mở gói nằm tại [`package.py`](../app/infrastructure/workspace/package.py#L466).
...
Luồng lưu nằm tại [`app/infrastructure/workspace/service.py`](../app/infrastructure/workspace/service.py#L111) và [`app/infrastructure/workspace/package.py`](../app/infrastructure/workspace/package.py#L574).
...
Phần tạo workspace tạm nằm tại [`package.py`](../app/infrastructure/workspace/package.py#L682). Phần quản lý mật khẩu phiên và dọn dẹp nằm tại [`package.py`](../app/infrastructure/workspace/package.py#L339).
...
Phụ thuộc được khai báo trong [`app/pyproject.toml`](../app/pyproject.toml):
