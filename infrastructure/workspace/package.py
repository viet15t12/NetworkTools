...
class PackageLimits:
    ...
    # CAMS-created projects have no arbitrary size/count ceiling.
    ...
    # The manifest is generated by CAMS and grows with its checksum
...
class WorkspacePackageCodec:
        ...
        *,
        ...
        if expected_fingerprint is not None:
            ...
            if current_fingerprint != expected_fingerprint:
                raise WorkspaceConflictError(
                    "The project file was modified outside CAMS."
                )
        ...
        try:
            ...
            if expected_fingerprint is not None:
                ...
                if current_fingerprint != expected_fingerprint:
                    raise WorkspaceConflictError(
                        "The project file was modified outside CAMS while saving.",
                        str(temporary_target),
                    )
    ...
    def _validate_project_path(
        ...
        if path.suffix.lower() != ".ntp":
            raise ValueError("CAMS project files must use the .ntp extension.")
        if must_exist:
    ...
    def _read_manifest(self, archive: zipfile.ZipFile) -> WorkspaceManifest:
        ...
        if _version_tuple(manifest.minimum_reader_version) > _version_tuple(
            ...
            raise UnsupportedWorkspaceVersion(
                "This project requires a newer CAMS version."
            )
        return manifest
