...
Đường dẫn canonical là `vendor/alacritty`. `src/` bên trong
`vendor/alacritty/alacritty/` chỉ là source Rust của crate upstream. Đặt
third-party source ở `vendor/` cấp app giúp
