...
| :---: | :---: | :--- |
| **Nguyễn Quốc Việt** *(Trưởng nhóm)* | N24DCVT113 | Kiến trúc dữ liệu, quản trị cơ sở dữ liệu SQLite, tích hợp giữa các lớp của hệ thống, mô-đun Syslog, tích hợp SFTP, điều phối kỹ thuật và hợp nhất mã nguồn |
| **Nguyễn Phan Kiên** | N24DCVT046 | Nền tảng backend, logic nghiệp vụ cho các phân hệ mạng, mẫu cấu hình Jinja2, đồng bộ running-config, kiểm thử tích hợp |
| **Nguyễn Trần Đạt Phú** | N24DCVT072 | Thiết kế giao diện người dùng, trải nghiệm sử dụng, biên soạn tài liệu, quản lý kho mã nguồn |
